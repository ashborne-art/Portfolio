  ...
  useEffect(() => {
    const fetchSkills = async () => {
      try {
        ...
        setLangSkills(Array.isArray(res.data.LangSkills) ? res.data.LangSkills : []);
        setToolsSkills(Array.isArray(res.data.ToolsSkills) ? res.data.ToolsSkills : []);
      } catch (err) {
  ...
  return (
    <div className='skills-container'>
      ...
      <div className='cardscontainer'>
        {devSkills.map(skill => (
          <div className='tooltip' key={skill._id || skill.name}>
